...
import 'package:real_football/widgets/item_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  MyHomePage({super.key, required ColorScheme colorScheme}); //sudah ada pada code sebelumnya
    ...
    final String nama = "Aufa Daffa' Satriatama"; //nama
    final String npm = "2406426321"; //npm
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Real Football" dengan teks putih dan tebal.
        title: const Text(
          'Real Football',
          style: TextStyle(
            color: Colors.white,
